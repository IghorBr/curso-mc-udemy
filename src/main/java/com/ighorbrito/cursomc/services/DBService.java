...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		ctg1.getProdutos().addAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20,
		p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p34, p35, p36, p37, p38,
		p39, p40, p41, p42, p43, p44, p45, p46, p47, p48, p49, p50));
		
		p12.getCategorias().add(ctg1);
		p13.getCategorias().add(ctg1);
		p14.getCategorias().add(ctg1);
		p15.getCategorias().add(ctg1);
		p16.getCategorias().add(ctg1);
		p17.getCategorias().add(ctg1);
		p18.getCategorias().add(ctg1);
		p19.getCategorias().add(ctg1);
		p20.getCategorias().add(ctg1);
		p21.getCategorias().add(ctg1);
		p22.getCategorias().add(ctg1);
		p23.getCategorias().add(ctg1);
		p24.getCategorias().add(ctg1);
		p25.getCategorias().add(ctg1);
		p26.getCategorias().add(ctg1);
		p27.getCategorias().add(ctg1);
		p28.getCategorias().add(ctg1);
		p29.getCategorias().add(ctg1);
		p30.getCategorias().add(ctg1);
		p31.getCategorias().add(ctg1);
		p32.getCategorias().add(ctg1);
		p33.getCategorias().add(ctg1);
		p34.getCategorias().add(ctg1);
		p35.getCategorias().add(ctg1);
		p36.getCategorias().add(ctg1);
		p37.getCategorias().add(ctg1);
		p38.getCategorias().add(ctg1);
		p39.getCategorias().add(ctg1);
		p40.getCategorias().add(ctg1);
		p41.getCategorias().add(ctg1);
		p42.getCategorias().add(ctg1);
		p43.getCategorias().add(ctg1);
		p44.getCategorias().add(ctg1);
		p45.getCategorias().add(ctg1);
		p46.getCategorias().add(ctg1);
		p47.getCategorias().add(ctg1);
		p48.getCategorias().add(ctg1);
		p49.getCategorias().add(ctg1);
		p50.getCategorias().add(ctg1);
		...
		Cliente cl1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("123"));
		
		Cliente cl2 = new Cliente(null, "Ademir Santos", "ademir@gmail.com", "36378912377", TipoCliente.PESSOA_FISICA, pe.encode("321"));
		cl2.addPerfil(Perfil.ADMIN);

		cl1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		cl2.getTelefones().addAll(Arrays.asList("38453945", "234502934"));
		...
		Endereco e3 = new Endereco(null, "Rua Zenith", "120", "", "Vila de Cava", "38777012", cl2, c2);
