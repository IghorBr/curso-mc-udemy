...
public class ProdutoService {
	...
	public Produto searchById(Integer id) {
		...
		return obj.orElseThrow(() -> new ObjectNotFoundException(
				"Objeto de ID " + id + " não encontrado " + "Tipo: " + Pedido.class.getName()));
	}

	public Page<Produto> searchByNameCategoria(String nome, List<Integer> ids, Integer page, Integer linesPerPage,
